...
def zodiac_characteristics(input):
    ...
    if zodiac_number == 1:
        ...
        taurus()
        print(Fore.CYAN + Style.BRIGHT +
              "  Taurus are powerful! Their characteristics include:\n"
              "  T for trustworthy\n"
              "  A for artistic\n"
              "  U for unyielding\n"
              "  R for reliable\n"
        ...
        gemini()
        print(Fore.CYAN + Style.BRIGHT +
              "  Gemini are great communicators! Their traits are:\n"
              "  G for gregarious\n"
              "  E for energetic\n"
        ...
        cancer()
        print(Fore.CYAN + Style.BRIGHT +
              "  Cancer are caring! Their name reflects:\n"
              "  C for compassionate\n"
              "  A for adaptable\n"
              "  N for nurturing\n"
              "  C for cautious\n"
        ...
        leo()
        print(Fore.CYAN + Style.BRIGHT +
              "  Leo are luminous! They shine with:\n"
              "  L for loyal\n"
              "  E for energetic\n"
              "  O for outgoing\n")
        return
        ...
        virgo()
        print(Fore.CYAN + Style.BRIGHT +
              "  Virgo are virtuous! Their virtues include:\n"
              "  V for virtuous\n"
              "  I for intelligent\n"
              "  R for realistic\n"
              "  G for grounded\n"
        ...
        libra()
        print(Fore.CYAN + Style.BRIGHT +
              "  Libra are balanced! They are known for:\n"
              "  L for lovable\n"
              "  I for idealistic\n"
              "  B for balanced\n"
              "  R for reasonable\n"
        ...
        scorpio()
        print(Fore.CYAN + Style.BRIGHT +
              "  Scorpio are strong! Their strengths are:\n"
              "  S for strategic\n"
              "  C for charismatic\n"
              "  O for observant\n"
              "  R for resilient\n"
        ...
        sagittarius()
        print(Fore.CYAN + Style.BRIGHT +
              "  Sagittarius are adventurous! Their traits are:\n"
              "  S for spontaneous\n"
              "  A for adventurous\n"
              "  G for generous\n"
              "  I for inspirational\n"
        ...
        capricorn()
        print(Fore.CYAN + Style.BRIGHT +
              "  Capricorn are capable! They excel in:\n"
              "  C for competent\n"
              "  A for ambitious\n"
              "  P for practical\n"
              "  R for resilient\n"
        ...
        aqurius()
        print(Fore.CYAN + Style.BRIGHT +
              "  Aquarius are analytical! Known for:\n"
              "  A for analytical\n"
              "  Q for quirky\n"
              "  U for unorthodox\n"
              "  A for assertive\n"
...
def replay():
    """
    Asks user whether they wanna play again
    and runs a while loop based on the input.
